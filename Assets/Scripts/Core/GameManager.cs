...
using NexusPrime.Technology;
using NexusPrime.Factions;
using NexusPrime.Campaign;
...
namespace NexusPrime.Core
{
    public class GameManager : MonoBehaviour
    {
        ...
        public event Action<SelectableUnit> OnUnitDestroyed;
        ...
        private void CheckGameConditions()
        {
            ...
            {
                if (building.buildingId == "command_center" && building.IsAlive())
                {
